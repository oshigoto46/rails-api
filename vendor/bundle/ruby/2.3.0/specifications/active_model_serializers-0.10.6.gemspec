...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<activemodel>.freeze, [">= 4.1", "< 6"])
    s.add_runtime_dependency(%q<actionpack>.freeze, [">= 4.1", "< 6"])
    s.add_development_dependency(%q<railties>.freeze, [">= 4.1", "< 6"])
    s.add_runtime_dependency(%q<jsonapi-renderer>.freeze, [">= 0.1.1.beta1", "< 0.2"])
    s.add_runtime_dependency(%q<case_transform>.freeze, [">= 0.2"])
    s.add_development_dependency(%q<activerecord>.freeze, [">= 4.1", "< 6"])
    ...
    s.add_dependency(%q<activemodel>.freeze, [">= 4.1", "< 6"])
    s.add_dependency(%q<actionpack>.freeze, [">= 4.1", "< 6"])
    s.add_dependency(%q<railties>.freeze, [">= 4.1", "< 6"])
    s.add_dependency(%q<jsonapi-renderer>.freeze, [">= 0.1.1.beta1", "< 0.2"])
    s.add_dependency(%q<case_transform>.freeze, [">= 0.2"])
    s.add_dependency(%q<activerecord>.freeze, [">= 4.1", "< 6"])
